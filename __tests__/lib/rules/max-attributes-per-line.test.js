    ...
    invalid: [
        {
            filename: 'test.san',
            code: `
                <template><component name="John Doe" age="30"></component></template>
            `,
            output: `
                <template><component name="John Doe"
        ...
        },
        {
            filename: 'test.san',
            code: `
                <template><component :name="user.name" :age="user.age"></component></template>
            `,
            output: `
                <template><component :name="user.name"
        ...
        },
        {
            filename: 'test.san',
            code: `
                <template><component :is="test" s-bind="user"></component></template>
            `,
            output: `
                <template><component :is="test"
        ...
        },
        {
            filename: 'test.san',
            code: `
                <template><component :name="user.name" @buy="buyProduct"></component></template>
            `,
            output: `
                <template><component :name="user.name"
        ...
        },
        {
            filename: 'test.san',
            code: `
                <template><component :name="user.name" @click.stop></component></template>
            `,
            output: `
                <template><component :name="user.name"
        ...
        },
        {
            filename: 'test.san',
            code: `
                <template><component :name="user.name" s-if="something"></component></template>
            `,
            output: `
                <template><component :name="user.name"
        ...
        },
        {
            filename: 'test.san',
            code: `
                <template><component name="John Doe"    s-bind:age="user.age"></component></template>
            `,
            output: `
                <template><component name="John Doe"
        ...
        },
        {
            filename: 'test.san',
            code: `
                <template><component name="John Doe" age="30" job="Vet"></component></template>
            `,
            options: [{singleline: {max: 2}}],
            output: `
                <template><component name="John Doe" age="30"
