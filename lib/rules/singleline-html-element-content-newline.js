...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            url: 'https://ecomfe.github.io/eslint-plugin-san/rules/singleline-html-element-content-newline.html'
        },
        fixable: 'whitespace',
        schema: [
            {
        ...
        return utils.defineTemplateBodyVisitor(context, {
            ...
            VElement(node) {
                ...
                if (
                    ...
                    template.getFirstTokensBetween(elem.startTag, elem.endTag, getTokenOption).length === 0
                ) {
                    return;
                }

                const contentFirst = /** @type {Token} */ (template.getTokenAfter(elem.startTag, getTokenOption));
                const contentLast = /** @type {Token} */ (template.getTokenBefore(elem.endTag, getTokenOption));
