...
const SPECIAL_TEMPLATE_DIRECTIVES = new Set(['if', 'else', 'else-if', 'for', 'slot']);
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            url: 'https://ecomfe.github.io/eslint-plugin-san/rules/no-lone-template.html'
        },
        fixable: null,
        schema: [
            {
    ...
    create(context) {
        ...
        function getKeyName(attr) {
            if (attr.directive) {
                ...
                if (!attr.key.argument || attr.key.argument.type === 'VExpressionContainer') {
                    // unknown
                    return null;
                }
