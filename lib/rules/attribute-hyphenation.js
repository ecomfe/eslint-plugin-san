...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            url: 'https://ecomfe.github.io/eslint-plugin-san/rules/attribute-hyphenation.html'
        },
        fixable: 'code',
        schema: [
            {
        ...
        return utils.defineTemplateBodyVisitor(context, {
            VAttribute(node) {
                ...
                const name = !node.directive
                    ...
                    ? node.key.argument && node.key.argument.type === 'VIdentifier' && node.key.argument.rawName
                    : /* otherwise */ false;
