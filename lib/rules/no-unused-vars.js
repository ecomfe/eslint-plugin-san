/**
 * @fileoverview disallow unused variable definitions of s-for directives or scope attributes.
...
function isDestructuringVar(variable) {
    ...
    while (parent) {
        if (parent.type === 'VForExpression' || parent.type === 'VSlotScopeExpression') {
            return false;
        }
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            url: 'https://ecomfe.github.io/eslint-plugin-san/rules/no-unused-vars.html'
        },
        fixable: null,
        schema: [
            {
