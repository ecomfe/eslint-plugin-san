...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            url: 'https://ecomfe.github.io/eslint-plugin-san/rules/no-parsing-error.html'
        },
        fixable: null,
        schema: [
            {
            ...
            Program(program) {
                ...
                if (Array.isArray(node)) {
                    for (const templateBody of node) {
                        if (templateBody && Array.isArray(templateBody.errors)) {
                            errors.push(...templateBody.errors);
                        }
                    }
                ...
                for (const error of errors) {
                    ...
                    context.report({
                        ...
                        data: {
                            message: error.message.endsWith('.') ? error.message.slice(0, -1) : error.message
                        }
                    });
                }
            }
