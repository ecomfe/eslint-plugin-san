...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            url: 'https://ecomfe.github.io/eslint-plugin-san/rules/multiline-html-element-content-newline.html'
        },
        fixable: 'whitespace',
        schema: [
            {
        ...
        return utils.defineTemplateBodyVisitor(context, {
            VElement(node) {
                ...
                if (
                    ...
                    template.getFirstTokensBetween(element.startTag, element.endTag, getTokenOption).length === 0
                ) {
                    return;
                }

                const contentFirst = /** @type {Token} */ (template.getTokenAfter(element.startTag, getTokenOption));
                const contentLast = /** @type {Token} */ (template.getTokenBefore(element.endTag, getTokenOption));
