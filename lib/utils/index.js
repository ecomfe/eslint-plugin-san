...
// 源码来自于 eslint-plugin-vue，所以直接关闭eslint
/* eslint-disable */
...
const vueEslintParser = require('san-eslint-parser');
        ...
        return {
            ...
            meta: Object.assign({}, coreRule.meta, {
                docs: Object.assign({}, coreRule.meta.docs, {
                    category: null,
                    categories,
                    url: `https://eslint.sanjs.org/rules/${path.basename(coreRule.meta.docs.url || '')}.html`,
                    extensionRule: true,
...
function isSanInstance(node) {
    const callee = node.callee;
    console.log('isSanInstance:', node.type, callee.type, callee.name, node.arguments.length)
    return Boolean(
