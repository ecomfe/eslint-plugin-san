...
- [Rule source](https://github.com/vuejs/eslint-plugin-san/blob/master/lib/rules/comment-directive.js)
- [Test source](https://github.com/vuejs/eslint-plugin-san/blob/master/tests/lib/rules/comment-directive.js)
